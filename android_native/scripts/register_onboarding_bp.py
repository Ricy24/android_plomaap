...
BACKUP_PATH = INIT_PATH + ".bak_fase8"
...
if "from app.routes.onboarding import onboarding_bp" not in code:
    code = code.replace(
...
if "app.register_blueprint(onboarding_bp)" not in code:
    code = code.replace(
...
print(f"[OK] app/__init__.py actualizado con onboarding_bp")
